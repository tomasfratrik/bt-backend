...
class Image:
    def __init__(self, file):
        # self._file = file
        self.set_file(file)
        self.set_original_filename(file.filename)
    ...
    def _parse_filename(self):
        self.set_extention(self.get_file().filename.split('.')[-1])
        self.set_name(self.get_file().filename.split('.')[0])
    ...
    def set_original_filename(self, name):
        self._origianl_filename = name

    def get_original_filename(self):
        return self._origianl_filename
